...
function App() {
  ...
  return (
    ...
    >
      ...
      <GridItem area={'main'}>
        <PlatformSelector selectedPlatform={selectedPlateform} onSelectedPlatform={(plateform) => setSelectedPlateform(plateform)}/>
        <GameGrid selectedGenre={selectedGenre} selectedPlatform={selectedPlateform} />
      </GridItem>
    </Grid>
  )
}
